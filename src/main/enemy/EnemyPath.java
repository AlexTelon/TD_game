...
*/
    ...
    /**
     * Gets the position for the next goalPoint for enemy
     * @return
     */
    ...
    /**
     * Method that calculates the path that the enemy will take. Is now hardcoded to follow a certain pattern to
     * the goals, but in the future this should be made to use the exact same method that enemy use for determening
