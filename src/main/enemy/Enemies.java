...
public class Enemies extends Placeable {
     ...
     * objects could be done by creating new objects using dead enemy as Prototypes but setting alive and active to
     * true for example.
     * The activationTime for the prototype is not used directly as we do not want all enemy to appear on the field
     * at the same time as the first, hence activationTime can be altered for the enemy.
     *
     ...
     * tick for enemy: Check if enemy should be activated, if it should move and if it should die and depending on
